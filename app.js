/* Graza × Vesper Commerce — 1-hour delivery mockup interactions */

// ---------- Product catalog (homepage grid) ----------
const PRODUCTS = [
  {
    "line": "Extra Virgin Olive",
    "name": "\u201cFrizzle\u201d Spray",
    "img": "assets/p0.jpg",
    "price": "$7.00",
    "status": "",
...
// ---------- On-demand catalog (Graza Now page) ----------
const NOW_PRODUCTS = [
  {
    "line": "Extra Virgin Olive",
    "format": "Single",
...
// Graza Now address check -> reveal grid
function nowCheck() {
...
function setMode(mode) {
  ...
  if (addBtn && !isOneHr) {
    addBtn.textContent = mode === "subscribe" ? "Subscribe — $6.30" : "Add to cart — $7.00";
  }
}
function pdpCheck() {
...
const CO = { subtotal: 14.00, tax: 1.24, ship: 7.0, shipLabel: "1-Hour delivery" };
...
function placeOrder() {
  ...
  toast(oneHr ? "Order placed ⚡ Routing to nearest store — arriving in ~52 min"
              : "Order placed ✓ Thanks — your Graza order is confirmed.");
}
document.addEventListener("DOMContentLoaded", updateCheckoutTotals);

// ---------- Slide-out cart drawer + rewards meter ----------
const CART = {"name": "\u201cFrizzle\u201d Spray", "line": "Extra Virgin Olive", "img": "assets/p0.jpg", "unit": 7.0, "qty": 2, "sub": false};
const TIERS = [
...
function injectMobileMenu() {
  ...
  const active = location.pathname.endsWith("graza-now.html") ? "brand-now" : "";
  const wrap = document.createElement("div");
  wrap.innerHTML = `
    <div class="menu-overlay" id="menuOverlay" onclick="closeMenu()"></div>
    <nav class="mobile-menu" id="mobileMenu" aria-label="Menu">
      <div class="mm-head">
        <span class="wordmark">Graza</span>
      ...
      <div class="mm-links">
        ...
        <a href="graza-now.html" class="${active === "brand-now" ? "active" : ""}">Graza Now</a>
      </div>
      <div class="mm-cta"><a href="graza-now.html" class="btn btn-white btn-block">⚡ Check your address</a></div>
      <div class="mm-sub">
